...
PYTHONUNBUFFERED=1 CUDA_VISIBLE_DEVICES=${GPUs} accelerate launch --num_processes $NUM_PROCESSES --main_process_port 6002 train.py  \
  ...
  --sft \
   --output_dir="tmp-sd15-sft-0325" > sd15-sft-0325.txt 2>&1 &
